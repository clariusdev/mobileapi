...
import static me.clarius.mobileapi.quickstart.BuildConfig.CLARIUS_PACKAGE_NAME;
import static me.clarius.mobileapi.quickstart.BuildConfig.CLARIUS_SERVICE_NAME;
...
import me.clarius.mobileapi.quickstart.helper.Observer;

public class MainActivity extends AppCompatActivity {
    private MobileApiHelper api;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        api = new MobileApiHelper(this, CLARIUS_PACKAGE_NAME, CLARIUS_SERVICE_NAME);
        api.setObserver(new Observer(this, api));
    }
    ...
    private Map<Integer, MenuHandler> makeMenuHandlers() {
        ...
        ret.put(R.id.action_connect, () -> api.connect());
